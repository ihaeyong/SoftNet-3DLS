...
class hessian():
    ...
    def __init__(self, model, criterion, data=None, dataloader=None, cuda=True, mask=None):
        """
        ...
        if not self.full_dataset:
            ...
            if mask is not None:
                self.mask = mask
                outputs = self.model.forward(self.inputs, mask)
            else:
                self.mask = None
    ...
    def dataloader_hv_product(self, v):
        ...
        for inputs, targets in self.data:
            ...
            if self.mask is not None:
                outputs = self.model(inputs.to(device), self.mask)
            else:
